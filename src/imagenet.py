...
class MultiTaskFC(nn.Module):
    def __init__(self, inplanes, planes1, planes2):
        super(MultiTaskFC, self).__init__()
        self.fc1 = nn.Linear(inplanes, planes1)
        self.fc2 = nn.Linear(inplanes, planes2)
...
resnext_101_64x4d = nn.Sequential( # Sequential,
	...
	nn.AvgPool2d((14, 14),(1, 1)),
        nn.Dropout(0.5),
	Lambda(lambda x: x.view(x.size(0),-1)), # View,
        nn.Sequential(Lambda(lambda x: x.view(1,-1) if 1==len(x.size()) else x ),nn.Linear(2048,8142)), # Linear,
)
